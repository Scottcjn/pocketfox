/*
 * pocketfox_cacert.h — embedded Mozilla CA root bundle
 *
 * AUTO-GENERATED by tools/update_cacert.sh — DO NOT EDIT BY HAND.
 * Source: https://curl.se/ca/cacert.pem
 * Mozilla data date: Thu Jul 16 03:12:01 2026 GMT
 * Certificates: 119
 *
 * PEM cert blocks only (descriptive text stripped to save space).
 * sizeof() includes the trailing NUL, which mbedtls_x509_crt_parse
 * requires to be counted in the buffer length for PEM input.
 */
#ifndef POCKETFOX_CACERT_H
#define POCKETFOX_CACERT_H

static const char pocketfox_cacert_pem[] =
"-----BEGIN CERTIFICATE-----\n"
